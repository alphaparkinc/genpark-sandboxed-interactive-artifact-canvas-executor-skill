# genpark-sandboxed-interactive-artifact-canvas-executor-skill
...
> **GenPark AI Agent Skill** -- Sandboxed interactive artifact canvas executor & live component renderer (Claude Artifacts style)
